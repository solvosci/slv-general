        ...
        self._cr.execute('''
            CREATE VIEW %s AS 
                (
                    ...
                    sol.order_partner_id AS partner_id, sol.company_id, sol.product_id, sol.product_uom_qty, sol.price_unit,
                    sol.discount, sol.price_subtotal, so.currency_id, 'sale' AS type
                ...
                (
                    ...
                    pol.partner_id, pol.company_id, pol.product_id, -pol.product_uom_qty, pol.price_unit,
                    pol.discount, -pol.price_subtotal, po.currency_id, 'purchase' AS type
