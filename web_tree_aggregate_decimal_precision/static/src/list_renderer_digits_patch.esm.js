    ...
    get aggregates() {
        ...
        for (const column of this.allColumns) {
            ...
            if (func) {
                ...
                // si attrs.digits no es JSON válido (o no existe),
                // usamos field.digits, que es la precisión YA RESUELTA por el
                // servidor a partir del nombre de precisión decimal definido
                // en el campo
                let digits;
                if (attrs.digits) {
                    try {
